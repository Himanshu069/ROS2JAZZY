...
class ImageSubscriber(Node):
    ...
    def display_image(self):
        ...
        while rclpy.ok():
            ...
            if self.latest_frame is not None:
                ...
                # print("LAtest frame", self.latest_frame.shape)
    ...
    def add_small_pictures(self, img, small_images, size=(60, 80)):
        ...
        for small in small_images:
            ...
            # print("sizes", size[0])
            # print("Slice shape:", img[10:130, x_offset:x_offset + size[0]].shape)
            # print("SHAPE ",(img[y_offset: y_offset + size[1], x_offset: x_offset + size[0]]).shape)
